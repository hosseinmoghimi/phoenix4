...
urlpatterns = [
    ...
    path('material_requests/',views.MaterialViews().material_requests,name="material_requests"),
    path('service_requests/',views.ServiceViews().service_requests,name="service_requests"),
    ...
    path('ware_house_sheet/<int:pk>/',views.WareHouseViews().ware_house_sheet,name="ware_house_sheet"),
