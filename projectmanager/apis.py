...
from projectmanager.serializers import EmployeeSerializer, EmployeeSerializer2, EventSerializer, MaterialRequestSerializer,EmployerSerializer, MaterialSerializer, OrganizationUnitSerializer, ProjectSerializer, RequestSignatureSerializer, ServiceRequestSerializer, ServiceSerializer, WareHouseSheetSerializer
...
class ProjectApi(APIView):
    def add_location(self,request):
        ...
        if request.method=='POST':
            log=2
            add_location_form=AddExistingLocationForm(request.POST)
