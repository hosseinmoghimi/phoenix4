...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('app_name', models.CharField(blank=True, choices=[('web', 'web'), ('projectmanager', 'projectmanager'), ('core', 'core')], max_length=20, null=True, verbose_name='app_name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_data', models.CharField(blank=True, max_length=100, null=True, verbose_name='MetaData')),
                ...
                ('icon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.icon', verbose_name='icon')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='childs', to='core.basicpage', verbose_name='parent')),
                ('tags', models.ManyToManyField(blank=True, to='core.Tag', verbose_name='برچسب ها')),
            ],
            options={
