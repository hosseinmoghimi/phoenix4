...
class MaintenanceRepo():
    ...
    def add_maintenance(self,vehicle_id,maintenance_type,service_man_id,maintenance_date,paid,kilometer):
        if self.user.has_perm(APP_NAME+".add_manitenance"):
            ...
            maintenance=Maintenance(vehicle_id=vehicle_id,maintenance_type=maintenance_type,service_man=service_man,event_time=maintenance_date,paid=paid,kilometer=kilometer)
            maintenance.save()
            return maintenance        
