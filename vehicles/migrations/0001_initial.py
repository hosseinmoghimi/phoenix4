# Generated by Django 3.2.2 on 2021-11-29 21:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driving_license_photo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='driving_license_photoes', to='core.image', verbose_name='تصویر گواهینامه')),
                ('medical_license_photo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='medical_license_photoes', to='core.image', verbose_name='تصویر کارت بهداشت')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='vehicles.tripcategory', verbose_name='نوع سفر')),
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehicles.driver', verbose_name='driver')),
                ('passengers', models.ManyToManyField(blank=True, to='vehicles.Passenger', verbose_name='مسافر ها')),
                ('paths', models.ManyToManyField(blank=True, to='vehicles.TripPath', verbose_name='مسیر های سرویس')),
                ('vehicle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehicles.vehicle', verbose_name='vehicle')),
            ],
            options={
                'verbose_name': 'Trip',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_shift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehicles.workshift', verbose_name='شیفت کاری')),
            ],
            options={
