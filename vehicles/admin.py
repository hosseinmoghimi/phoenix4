...
from vehicles.models import Area, Driver, Maintenance, Passenger, ServiceMan, Trip, TripCategory, TripPath, Vehicle, VehicleEvent, VehicleLocation, VehicleWorkEvent, WorkShift
