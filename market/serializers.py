...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = ['id', 'title','price', 'thumbnail', 'get_absolute_url','barcode']
...
class CategorySerializer(serializers.ModelSerializer):
    class Meta:
        model = Category
        fields = ['id', 'title', 'get_absolute_url', 'thumbnail','parent_id']
...
class ShopSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Shop
        fields = ['id','specifications', 'supplier','level','product','old_price', 'unit_name', 'available', 'unit_price','get_edit_url','get_delete_url']
