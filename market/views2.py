...
from market.serializers import (CartLineSerializer, CartSerializer, CategorySerializer, CustomerSerializer, GuaranteeSerializer,
...
LAYOUT_PARENT = "material-kit-pro/layout.html"
LAYOUT_PARENT = "market2/layout.html"
...
def getContext(request, *args, **kwargs):
    ...
    root_categories=CategoryRepo(
        request=request).list(for_home=True)
    context['root_categories'] = root_categories
    context['root_categories_s'] = json.dumps(CategorySerializer(root_categories,many=True).data)
