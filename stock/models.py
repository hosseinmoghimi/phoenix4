...
class Stock(models.Model):
    ...
    father_name=models.CharField(_("نام پدر"),null=True,blank=True, max_length=50)
    ...
    melli_code=models.CharField(_("کد ملی"),null=True,blank=True, max_length=50)
    sh_sh=models.CharField(_("شماره شناسنامه"),null=True,blank=True, max_length=50)
    address=models.CharField(_("آدرس"),null=True,blank=True, max_length=100)
...
class Payment(models.Model):
    ...
    image_origin=models.ImageField(_("image"),null=True,blank=True, upload_to=IMAGE_FOLDER+"Payment", max_length=100)
    date_paid=models.DateTimeField(_("date paid"), auto_now=False, auto_now_add=False)
    payment_type=models.CharField(_("payment type"),choices=PaymentTypeEnum.choices,default=PaymentTypeEnum.CASH, max_length=50)
    class_name="payment"
    def image(self):
